...
$$
\begin{cases}
N\frac{di(t)}{dt}=\lambda s(t)Ni(t)\\
s(t)+i(t)=1
\end{cases}
$$
...
$$
\begin{cases}
N\frac{ds}{dt}=-Ni\lambda s(t)\\
N\frac{di}{dt}=Ni\lambda s(t)-Ni(t)\mu\\
s(t)+i(t)+r(t)=1
\end{cases}
$$

> 取一极小段时间变化，由于这里是s、i、r三者有和为1的关系，所以关于其中的两个再列一个额外的方程即可，这里选择的是s和i：
>
